                ...
                <header class="contact-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="dropdown ms-3">
                            <a href="{{ route('abrir_create_clientes') }}"
                                class="btn btn-sm btn-outline-secondary flex-shrink-0 ">Create New</a>
                                            ...
                                            <td>
                                                <div class="media align-items-center">
                                                    ...
                                                    <div class="media-body">
                                                        <span
                                                            class="d-block text-high-em">{{ $cliente['nombre_cliente'] . ' ' . $cliente['apellido_cliente'] }}</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-truncate">{{ $cliente['nit_cliente'] }}</td>
