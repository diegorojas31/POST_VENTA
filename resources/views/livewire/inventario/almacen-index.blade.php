                ...
                <tbody>
                    @foreach ($almacens as $almacen)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('almacenes.edit', $almacen->id) }}" class="btn btn-primary btn-sm">
                                    <i class="fa fa-edit"></i> Editar
                                </a>
                                <!-- Icono de eliminar con formulario (puedes usar un modal para confirmar la eliminación) -->
                                <button wire:click="disable({{ $almacen->id }})" class="btn btn-danger btn-sm"
    ...
    <div class="modal fade" id="modal-lg" style="display: none;" aria-hidden="true" wire:ignore.self>
        <div class="modal-dialog">
            <div class="modal-content">
                @livewire('inventario.almacen-create')
            </div>
        </div>
    </div>
</div>
