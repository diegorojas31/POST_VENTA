        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content bg-info">
                ...
                <div class="modal-body text-center">
                    <div class="row">
                        <div class="col-md-4">
                            <a href="{{route('inventario_analitico')}}" class="text-decoration-none">
                                <div class="mb-3">
                        ...
                        <div class="col-md-4">
                            <a href="{{route('inventario_ejecutivo')}}" class="text-decoration-none">
                                <div class="mb-3">
                        ...
                        <div class="col-md-4">
                            <a href="{{route('inventario_personalizado')}}" class="text-decoration-none">
                                <div class="mb-3">
