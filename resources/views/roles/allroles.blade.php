...
@section('content')
    ...
    <a href="{{route('crear_roles')}}">
        <x-adminlte-button label="Crear Rol"/>
    </a>
                            ...
                            <td>
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        <span class="d-block text-high-em">{{ $rol->name}}</span> 
                                    </div>
                                </div>
                            </td>
                            <td class="text-truncate">permisos</td>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="d-flex">
                                        ...
                                        <a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Edit" href="#"><span class="icon"><span class="feather-icon"><i data-feather="edit"></i></span></span></a>
